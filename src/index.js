...
// this gotta be the shittiest code here :skull:
...
server.on('listening', () => {
  ...
  console.log(`Riptide running on port ${addr.port}`)
	console.log('');
  console.log('go on port 8080 u doofus.')
